        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a onclick="event.preventDefault(); document.getElementById('logout-form').submit()" class="dropdown-item" type="button">Çıkış Yap</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route("cart")}}">Cart ({{\Cart::getTotalQuantity()}})</a>
                </li>
                @endauth
        </ul>
